...
contract MyFirstERC20Coin {
    ...
    //Переменная с минимальным числом голосов
    uint256 public minVotes = 6;

    //Переменная с предложенным названием
    string public proposalName;

    //Переменная для статуса голосования
    ...
    //Функция предложения нового имени
    function newName(string _proposalName) public {

        //Проверяем, что не идет голосования
        require(!voteActive);
    ...
    function changeName() public {
        ...
        //Если собрали нужное кол-во голосов - обнавляем имя
